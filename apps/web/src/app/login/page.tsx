            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-1.5">
                {[
                  ...
                  { stage: 4, role: "Contractor Coord", email: "contractor.coord@kenzo-ehs.com", desc: "Assesses repairs & forwards" },
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-1">
                {[
                  ...
                  { role: "Environment Manager", email: "environment.mgr@kenzo-ehs.com" },
