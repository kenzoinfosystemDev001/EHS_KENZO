...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-slate-900 text-white flex flex-col h-screen sticky top-0 custom-scrollbar">
      <div className="px-5 py-5 border-b border-slate-700/50 bg-slate-900/95 sticky top-0 z-10 backdrop-blur-sm">
