...
export class HiraController {
  ...
  @RequirePermissions(Permissions.HIRA_UPDATE)
  @ApiOperation({ summary: 'Identify hazard, controls, and compute server-side risk assessment' })
  async addHazard(
    @Param('id') id: string,
  ...
  @ApiOperation({ summary: 'Explicit Action: Submit HIRA study for team review' })
  async submit(
    @Param('id') id: string,
  ...
  @ApiOperation({ summary: 'Explicit Action: Recommend for approval or request rework' })
  async review(
    @Param('id') id: string,
    @Body() dto: HiraActionDto,
  ...
  @RequirePermissions(Permissions.HIRA_APPROVE)
  @ApiOperation({ summary: 'Explicit Action: Reject HIRA study back to IN_PROGRESS' })
  async reject(
    @Param('id') id: string,
    @Body() dto: HiraActionDto,
    @CurrentUser() user: AuthenticatedUserContext,
  ...
  @ApiOperation({ summary: 'Explicit Action: Activate approved HIRA study for site operations' })
  async activate(
    @Param('id') id: string,
    @CurrentUser() user: AuthenticatedUserContext,
  ) {
