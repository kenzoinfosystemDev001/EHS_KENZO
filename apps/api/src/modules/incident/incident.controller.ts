...
export class IncidentController {
  ...
  async create(@Body() dto: CreateIncidentDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  async report(@Param('id') id: string, @Body() dto: IncidentActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  async classify(@Param('id') id: string, @Body() dto: IncidentActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  async investigate(@Param('id') id: string, @Body() dto: IncidentActionDto, @CurrentUser() user: AuthenticatedUserContext) {
    return this.incidentService.executeAction(id, 'START_INVESTIGATION', user, dto);
  }
  ...
  async initiateRca(@Param('id') id: string, @Body() dto: IncidentActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  async requestClosure(@Param('id') id: string, @Body() dto: IncidentActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  async close(@Param('id') id: string, @Body() dto: IncidentActionDto, @CurrentUser() user: AuthenticatedUserContext) {
