...
export class CapaController {
  ...
  async create(@Body() dto: CreateCapaDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  async assign(@Param('id') id: string, @Body() dto: CapaActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  @HttpCode(HttpStatus.OK)
  async start(@Param('id') id: string, @Body() dto: CapaActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  @RequirePermissions(Permissions.CAPA_EXECUTE)
  @HttpCode(HttpStatus.OK)
  async submitVerification(@Param('id') id: string, @Body() dto: CapaActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  @HttpCode(HttpStatus.OK)
  async verify(@Param('id') id: string, @Body() dto: CapaActionDto, @CurrentUser() user: AuthenticatedUserContext) {
  ...
  @HttpCode(HttpStatus.OK)
  async close(@Param('id') id: string, @Body() dto: CapaActionDto, @CurrentUser() user: AuthenticatedUserContext) {
